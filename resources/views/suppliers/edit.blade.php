            ...
            <div class="row">
                <div class="col col-lg-4">
                    <div class="form-group">
                        ...
                        {{Form::text('supplier_NAME', $supplier->supplier_NAME, ['class' => $invalid, 'placeholder' => 'np. Integart'])}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('supplier_ADDRESS', $supplier->supplier_ADDRESS, ['class' => $invalid, 'placeholder' => 'np. ul. Sucha 1, 54-515 Wrocław'])}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('supplier_PHONE', $supplier->supplier_PHONE, ['class' => $invalid, 'placeholder' => 'np. +48 888 888 888'])}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('supplier_EMAIL', $supplier->supplier_EMAIL, ['class' => $invalid, 'placeholder' => 'np. kontakt@dostawca.com'])}}
                    </div><br>
                        ...
                        <div class="card-body">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    {{Form::text('supplier_REP_NAME', $supplier->supplier_REP_NAME, ['class' => $invalid, 'placeholder' => 'np. Jan Kowalski'])}}
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('supplier_REP_PHONE', $supplier->supplier_REP_PHONE, ['class' => $invalid, 'placeholder' => 'np. +48 888 888 888'])}}
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('supplier_REP_EMAIL', $supplier->supplier_REP_EMAIL, ['class' => $invalid, 'placeholder' => 'jankowalski@dostawca.com'])}}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col col-lg-6">  
                    <div class="form-group">
                        ...
                        {{Form::textarea('supplier_DESCRIPTION', $supplier->supplier_DESCRIPTION, ['id' => 'article-ckeditor', 'class' => $invalid])}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('supplier_URL', $supplier->supplier_URL, ['class' => $invalid, 'placeholder' => 'http://www....'])}}
                    </div>
