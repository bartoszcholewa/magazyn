        ...
        <div class="col col-lg-4">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-12">
                    ...
                    {{Form::select('order_ROLL_ID', $rolls, Request::get('roll'), ['class' => $invalid, 'placeholder' => 'Wybierz rolkę...'])}}
            ...
            <div class="form-group no-gutter">
                <div class="row">
                    <div class="col-sm no-gutter">
                        ...
                        {{Form::text('order_CLIENT_NAME', '', ['class' => $invalid, 'placeholder' => 'np. Jan'])}}
                    </div>
                    <div class="col-sm no-gutter">
                        ...
                        {{Form::text('order_CLIENT_SURNAME', '', ['class' => $invalid, 'placeholder' => 'np. Kowalski'])}}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                {{Form::text('order_DESCRIPTION', '', ['class' => $invalid, 'placeholder' => 'np. odbiór osobisty'])}}
            </div>
